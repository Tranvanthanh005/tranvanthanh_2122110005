<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                 Văn Thành Shop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
               ...
               <p class="pt-1">
                  Điện thoại: 09813834715(call, zalo) - Email: vanthanh@gmail.com
               </p>
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Trần Văn Thành - Phone: 09513834715
      </div>
   </section>
</body>
